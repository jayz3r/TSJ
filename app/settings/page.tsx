        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <div className="p-5 space-y-3">
              <div className="flex items-center gap-3 p-3 bg-stone-50 rounded-lg border border-stone-200 dark:bg-stone-900/60 dark:border-stone-800">
                ...
                <div>
                  <p className="text-sm font-medium text-stone-800 dark:text-stone-200">Администратор</p>
                  <p className="text-xs text-stone-400 dark:text-stone-500">admin@tszh-vesna.kg</p>
                </div>
              </div>
