    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        {[
          ...
          <div
            key={label}
            className="bg-stone-50 border border-stone-200 rounded-xl px-4 py-3 flex items-center gap-3 dark:bg-stone-900/60 dark:border-stone-800"
          >
            <span
          ...
          {requests.map((r) => (
            <div key={r.id} className="p-4 space-y-2">
              ...
              <select
                ...
                className="text-xs border border-stone-200 rounded-md px-2 py-1 bg-white focus:outline-none focus:border-emerald-500 dark:bg-stone-900 dark:border-stone-700 dark:text-stone-100"
              >
        ...
        <div className="hidden md:block overflow-x-auto">
          <table className="w-full text-sm min-w-[640px]">
            ...
            <tbody className="divide-y divide-stone-50">
              {requests.map((r) => (
                <tr key={r.id} className="hover:bg-stone-50 dark:hover:bg-stone-800/60">
                  <td className="px-4 py-2.5 font-mono text-xs text-stone-400 dark:text-stone-500">
                    #{r.id}
                  </td>
                  <td className="px-4 py-2.5 font-medium text-stone-700 dark:text-stone-300">
                    кв. {r.apartmentNumber}
                  </td>
                  <td className="px-4 py-2.5 text-stone-800 dark:text-stone-200">{r.subject}</td>
