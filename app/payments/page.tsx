  ...
  return (
    <div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <FormInput
                label="Сумма (сом)"
                type="number"
                placeholder={selectedApt ? String(selectedApt.monthlyFee) : '2400'}
      ...
      {receipt && (
        ...
        >
          <div
            className="bg-white rounded-xl border border-stone-200 p-6 w-80 shadow-xl"
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-xs text-stone-400 mt-0.5">ТСЖ «Весна» · ул. Ленина, 12</p>
              </div>
              <button
                onClick={() => setReceipt(null)}
            ...
            <div className="space-y-2 border-t border-stone-100 pt-3">
              {[
                ...
                ['Дата',       receipt.date],
                ['Способ',     receipt.method === 'bank' ? 'Банк (перевод)' : 'Наличные'],
